...
TIFFjpeg_write_scanlines(JPEGState* sp, JSAMPARRAY scanlines, int num_lines)
{
	return CALLJPEG(sp, -1, (int) jpeg_write_scanlines(&sp->cinfo.c,
	    scanlines, (JDIMENSION) num_lines, NULL));
}
...
{
	return CALLVJPEG(sp, jpeg_finish_compress(&sp->cinfo.c, NULL));
}
...
TIFFjpeg_read_scanlines(JPEGState* sp, JSAMPARRAY scanlines, int max_lines)
{
	return CALLJPEG(sp, -1, (int) jpeg_read_scanlines(&sp->cinfo.d,
	    scanlines, (JDIMENSION) max_lines, NULL));
}
...
static boolean
std_empty_output_buffer(j_compress_ptr cinfo, j_stream_ptr from_memory)
{
	JPEGState* sp = (JPEGState*) cinfo;
	TIFF* tif = sp->tif;
...
static void
std_term_destination(j_compress_ptr cinfo, j_stream_ptr from_memory)
{
	JPEGState* sp = (JPEGState*) cinfo;
	TIFF* tif = sp->tif;
...
static boolean
tables_empty_output_buffer( j_compress_ptr cinfo, j_stream_ptr from_memory)
{
	JPEGState* sp = (JPEGState*) cinfo;
	void* newbuf;

	/* the entire buffer has been filled; enlarge it by 1000 bytes */
	newbuf = TIFFRealloc(((TIFF*)(cinfo->client_data)), (tdata_t) sp->jpegtables,
...
static void
tables_term_destination(j_compress_ptr cinfo, j_stream_ptr from_memory)
{
	JPEGState* sp = (JPEGState*) cinfo;
...
static boolean
std_fill_input_buffer(j_decompress_ptr cinfo, j_stream_ptr from_memory )
{
	JPEGState* sp = (JPEGState* ) cinfo;
...
static void
std_skip_input_data(j_decompress_ptr cinfo, long num_bytes, j_stream_ptr from_memory)
{
	JPEGState* sp = (JPEGState*) cinfo;
...
TIFFInitJPEG(TIFF* tif, int scheme)
{
    ...
    sp->cinfo.c.client_data = tif->lib;
    sp->cinfo.d.client_data = tif->lib;
